...
def predict_labels(channels: List[str], data: np.ndarray, fs: float, reference_system: str, model_name: str) -> Dict[str, Any]:
    ...
    model_path = os.path.join('/home/jupyter-wki_team_2/Silvan/test_abgabe/', model_name)
    try:
        clf = load(model_path)
    ...
    scaler_path = os.path.join('/home/jupyter-wki_team_2/Silvan/test_abgabe/', 'scaler.pkl')
    try:
